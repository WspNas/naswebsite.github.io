...
let glitch;
let imgSrc =
    "https://cdn.discordapp.com/attachments/997792499659706368/1032169222631079936/unknown.png";
...
class Glitch {
    ...
    shiftRGB(srcImg) {
        ...
        destPixels = new Uint8ClampedArray(srcImg.pixels);
        randR =
            (floor(random(-range, range)) * srcImg.width + floor(random(-range, range))) *
            this.channelLen;
        randG =
            (floor(random(-range, range)) * srcImg.width + floor(random(-range, range))) *
            this.channelLen;
...
function goYoutube() {
    window.open("https://discord.com/users/794867763528466432", "_blank");
}
